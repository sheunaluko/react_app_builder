...
Medkit was written as a web application to optimize development iteration time and ease of application distribution. Specifically, Medkit utilizes [React](https://reactjs.org/) with the user interface framework (Material UI)[https://material-ui.com/] for interface development. [Typescript](https://www.typescriptlang.org/) is used for Widget creation. The combination of Typescript, React, and Material-UI achieves a robust harmony between software iteration time, stability, and likelihood of persistent functionality into the future. 
